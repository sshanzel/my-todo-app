...
export default function SignIn({onLogin, onRegister}) {
  ...
  const handleSubmit = async e => {
    ...
    const command = registration ? onRegister : () => onLogin({username, password});
      ...
      <div className={classes.paper}>
        ...
        <form className={classes.form} noValidate>
          ...
          <Grid container>
            ...
            <Grid item>
              <Link href='#' variant='body2' onClick={() => setRegistration(!registration)}>
                {!registration ? "Don't have an account? Sign Up" : 'Already Registered? Sign In'}
              </Link>
            </Grid>
          </Grid>
        </form>
